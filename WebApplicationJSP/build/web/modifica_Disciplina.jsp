<%-- 
    Document   : modifica_Disciplina
    Created on : Dec 27, 2018, 9:18:20 PM
    Author     : Andrei
--%>
...
<html>
    ...
    <body style="background-color: black;color:white" class="w3-container w3-center">
        <h1 class="w3-panel w3-topbar w3-bottombar w3-border-red w3-pale-red" align="center"> Tabela Disciplina:</h1>
        <br/>
        <p align="center" class="w3-button w3-black w3-round-xlarge "><a href="nou_Disciplina.jsp"><b>Adauga o noua disciplina.</b></a> <a class="w3-button w3-border w3-hover-teal w3-button w3-round-xlarge" href="index.html"><b>Home</b></a></p>
