<%-- 
    Document   : m2_Student
    Created on : Dec 27, 2018, 9:11:10 PM
    Author     : Andrei
--%>
...
<html>
    ...
    <body style="background-color: black;color: white">
        ...
        <%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idstudenti"));
            String nume = request.getParameter("nume");
            String prenume = request.getParameter("prenume");
            String grupa = request.getParameter("grupa");

            String[] valori = {nume, prenume, grupa};
            String[] campuri = {"nume", "prenume", "grupa"};
            jb.modificaTabela("studenti", "idstudenti", aux, campuri, valori);
            jb.disconnect();
        %>
