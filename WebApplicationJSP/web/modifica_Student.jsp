<%-- 
    Document   : modifica_Student
    Created on : Dec 27, 2018, 9:09:46 PM
    Author     : Andrei
--%>
...
<html>
    ...
    <body style="background-color: black;color: white" class="w3-container w3-center">
        ...
        <br/>
        <p align="center" class="w3-button w3-black w3-round-xlarge"><a href="nou_Student.jsp"><b>Adauga un nou Student.</b></a> <a class="w3-button w3-border w3-hover-teal w3-button w3-round-xlarge" href="index.html"><b>Home</b></a></p>
