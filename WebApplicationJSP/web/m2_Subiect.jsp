<%-- 
    Document   : m2_Subiect
    Created on : Dec 27, 2018, 9:15:20 PM
    Author     : Andrei
--%>
...
<html>
    ...
    <body style="background-color: black;color: white">
        ...
        <%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idsubiecte"));
            String tip = request.getParameter("tip");
            String nr_intrebari = request.getParameter("nr_intrebari");
           

            String[] valori = {tip, nr_intrebari};
            String[] campuri = {"tip", "nr_intrebari"};
            jb.modificaTabela("subiecte", "idsubiecte", aux, campuri, valori);
            jb.disconnect();
        %>
